...
from .eval_detection_clipart import eval_detection_clipart


def clipart_evaluation(dataset, predictions, output_dir, iteration=None):
    ...
    result = eval_detection_clipart(pred_bboxes=pred_boxes_list,
